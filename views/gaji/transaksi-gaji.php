...
if (isset($_GET['halaman'])) {
    ...
    if ($jenis==1) { // sortir data berdasarkan unit
        ...
        $header = array("No", "NIP", "Nama", "Jabatan", "Unit", "Periode Bulan", "Periode Tahun", "Upah", "BPJS Tenaga Kerja", "BPJS Kesehatan", "PPH21", "PPNI", "Lain-lain", "Tunjanagn Jabatan", "Tunjangan Fungsional", "Tunjangan TPBR/Khusus", "Fee For Servis", "Lembur Pelayanan", "Penyesuaian Gaji", "Tunjangan Lain-lain");
